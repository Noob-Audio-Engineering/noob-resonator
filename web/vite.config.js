...
// Vite configuration for the Noob Resonator SPA.
//
...
// 4246, the standalone's preferred port; if that port was taken the
// standalone moved up and printed the port it got):
//
//     cargo run --bin noob-resonator-standalone      # terminal 1
//     NOOB_VST_WEBGUI_FRAMEWORK_PORT=4246 npm run dev                     # terminal 2, in web/
const serverPort = process.env.NOOB_VST_WEBGUI_FRAMEWORK_PORT || '4246';
